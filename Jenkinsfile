pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL= 'https://github.com/TEAM-FLOWBIT/API_GATEWAY_SERVICE_MSA.git'

        //docker-hub
        registryCredential = 'docker-hub'

        CONTAINER_NAME = 'flowbit-apigateway'
        IMAGE_NAME = 'kimminwoo1234/flowbit-apigateway'
    }
    ...
    stages {
        ...
        stage('Prepare') {
            steps {
                ...
                git branch: 'develop',
                    url: 'https://github.com/TEAM-FLOWBIT/API_GATEWAY_SERVICE_MSA.git'
            }
            post {
                success {
